...
IndonesianStrings = {
    "main_start_pm": """Halo, saya *Filterry* \n.
*Saya adalah bot filter grup terbaik Telegram dengan fitur khusus* . \n
*Jangan ragu untuk menambahkan saya ke obrolan Anda* . \n
*Tekan /help untuk melihat fitur saya* . \n
*Didukung oleh @DevelopedBots * .
""",

    "send-help": """Hai! Nama saya *Filterry* . Saya Bot Filter dengan banyak fitur khusus . \n
*Perintah yang membantu* :
/start : mulai aku lagi
/help : periksa semua modul dan perintah
/connect (id grup): Hubungkan grup Anda
/source : Periksa detail tentang Sumber saya
/lang : Mengubah bahasa bot .

Jika Anda tidak tahu cara mengatur, periksa *Tutorial konfigurasi* .
...
#__main__
    #Module names
        ...
        "Command disabling": "Perintah Dinonaktifkan",
        "Locks": "Locks",
        "Log Channels": "Log Saluran",
        "Misc": "Lain-lain",
        "Purges": "Purges",
...
/start : mulai aku lagi
/help : periksa semua modul dan perintah
/koneksi (id grup): Hubungkan grup Anda
/source : Periksa detail tentang Sumber saya
/lang : Mengubah bahasa bot .
