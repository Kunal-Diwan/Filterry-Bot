RUN_STRINGS = (
    ...
    "हाँ? क्या? क्या वे बच सकते हैं?",
    "ZZzzZZzz... हुह? क्या? ओह, ये फिर से हैं, कोई बात नहीं।",
    "यहाँ वापस आओ!",
    "इतना शीघ्र नही...",
    "ध्यान दें कि कोई दीवार है!",
    "मुझे उनके साथ अकेला मत छोड़ो !!",
    "तुम भागो, तुम मर जाओ।",
    "मजाक कर रहा हूँ, मैं हर जगह हूँ",
    "तुम पछताओगे...",
    "क्लिक / किकमे करने का प्रयास करें, यह मजेदार है जिसे आप जानते हैं।",
    "बस वहां अन्य लोगों को परेशान करें, यहां किसी को परवाह नहीं है।"
    "आप दौड़ सकते हैं, लेकिन आप छिप नहीं सकते।"
    "आपके पास बस इतना ही है?"
    "मैं आपके पीछे हूं...",
    "अब आप अकेले नहीं हैं!",
    "हम इसे आसान या कठिन तरीके से कर सकते हैं।",
    "आप समझ नहीं रहे हैं, है ना?",
    "हाँ, तुम बेहतर दौड़ो!",
    "कृपया, मुझे याद दिलाएं कि मुझे कितनी परवाह है?",
    "अगर मैं तुम होते तो मैं तेजी से दौड़ता।",
    "यही वो ड्रॉइड्स होंगे जिनकी हम तलाश कर रहे थे।",
    "आपका मौका हमेशा भाग्यशाली रहे।",
    "प्रसिद्ध अंतिम शब्द।",
    "और वे हमेशा के लिए गायब हो गए, फिर कभी नहीं देखे जा सकते।"
    "ओह, मुझे देखो! मैं अच्छा हूँ तुम्हें पता है, मैं बॉट्स से भाग सकता हूँ! \n -यह आदमी",
    "हाँ हाँ, बस प्रेस / किकमे।",
    "यहाँ, इस अंगूठी को ले जाओ और जब आप इसमें हों तो मोर्डोर के पास जाओ।",
    "किंवदंती कहती है, वे अब तक चलते हैं...",
    "हैरी पॉटर के विपरीत, आपके माता-पिता मुझसे आपकी रक्षा नहीं कर सकते।",
    "डर से क्रोध होता है। क्रोध से घृणा होती है। घृणा से दुख होता है। यदि आप भय में भागते रहते हैं, तो हो सकता है"
    "वेदर के उत्तराधिकारी बनें।",
    "गणित करने के बाद, मैंने तय किया है कि आपके अपराध में मेरी रुचि 0 है।",
    "किंवदंती कहती है, वे अब भी चलते हैं।",
    "जाओ, हमें यकीन नहीं है कि हमें यहाँ तुम्हारी ज़रूरत है।",
    "आपको एक बदमाश होना चाहिए। रुको। तुम हैरी नहीं हो, आगे बढ़ो।",
    "दूर भागो मत!",
    "अलविदा बेबी।",
    "कुत्ते को किसने जाने दिया?",
    "यह मज़ेदार है, क्योंकि यहाँ किसी को परवाह नहीं है।"
    "आह, बहुत बुरा। हालांकि मुझे वह पसंद है।",
    "सच कहूं, मेरे प्रिय, मुझे परवाह नहीं है।",
    "मेरा मिल्कशेक सभी लड़कों को यार्ड में आकर्षित करता है ... इसलिए तेजी से दौड़ें!",
    "आप वास्तविकता को स्वीकार नहीं कर सकते!",
    "एक समय की बात है, एक आकाशगंगा में बहुत दूर ... शायद किसी को उसकी परवाह थी। लेकिन अभी नहीं।",
    "अरे, उन्हें देखो! वे अनिवार्य रूप से बैनहैमर से बच जाते हैं ... मज़ेदार बात यह है।",
    "हान पहले गोली मारता है। तो मैं भी।",
    "तुम क्या कर रहे हो, एक सफेद खरगोश?",
    "डॉक्टर शायद कहेंगे …… भागो!",
)

INSULTS_STRINGS = (
    "ओह ... वर्गों का बेवकूफ आधार।",
    "टाइप करते समय शराब न पिएं",
    "मुझे लगता है कि बेहतर होगा कि तुम घर जाओ, या अस्पताल भी जाओ।",
    "कमांड नहीं मिला। आपके मस्तिष्क की सामग्री की तरह।",
    "क्या आप जानते हैं कि आपका व्यवहार आपको बेवकूफ बनाता है? जाहिर तौर पर नहीं।",
    "आपको इससे बेहतर लिखने में सक्षम होना चाहिए।",
    "बीओटी नियम संख्या 544 भाग 9 मुझे आपके संदेशों का उत्तर देने से रोकता है।",
    "क्षमा करें, हम दिमाग नहीं बेचते।",
    "मेरा विश्वास करो, तुम सामान्य नहीं हो।",
    "मुझे यकीन है कि आपका दिमाग नया जैसा लगता है, क्योंकि आप इसका कभी भी उपयोग नहीं करते हैं।",
    "अगर मैं खुद को मारना चाहता, तो मैं तुम्हारे अहंकार की सवारी करता और तुम्हारे आईक्यू पर कूद पड़ता।",
    "लाश दिमाग खाते हैं... तो आप सुरक्षित हैं।",
    "आप वानरों से विकसित नहीं हुए, वे आपसे विकसित हुए हैं।"
    "जब आपका आईक्यू काउंट आपकी उम्र से अधिक हो जाए तो मुझसे बात करने के लिए वापस आएं।",
    "मैं यह नहीं कह रहा हूँ कि तुम मूर्ख हो, मैं बस इतना कह रहा हूँ कि जब तुम सोचते हो तो तुम बदकिस्मत हो।",
    "आप कौन सी भाषा बोलते हैं? क्योंकि यह बकवास लगता है",
    "मूर्खता कोई अपराध नहीं है इसलिए आपको रिहा कर दिया जाता है।"
    "आप सबूत हैं कि विकास को उलटा किया जा सकता है।",
    "मैं पूछना चाहता था कि तुम कितने साल के हो लेकिन मुझे पता है कि तुम इतना गिन नहीं पाओगे।",
    "एक एलियन के रूप में, आप मानव जाति के बारे में क्या सोचते हैं?",
    "मस्तिष्क ही सब कुछ नहीं है। आपके मामले में, मस्तिष्क वहां नहीं है।",
    "आमतौर पर लोग जीते हैं और सीखते हैं। आप बस जी रहे हैं।",
    "मुझे नहीं पता कि आपको क्या बेवकूफ बनाता है, लेकिन यह वास्तव में काम करता है।",
    "बात करते रहो, किसी दिन तुम कुछ चतुर कहोगे! (हालांकि मुझे इसमें संदेह है)",
    "मुझे कुछ ऐसा कहकर आश्चर्यचकित करें जो स्मार्ट लगता है।"
    "आपका आईक्यू आपके जूते के आकार से छोटा है।",
    "आउच! आपका न्यूरोट्रांसमीटर टूट गया है।",
    "क्या तुम पागल हो, तुम मूर्ख हो।",
    "बेवकूफ होने का हक हर किसी को है लेकिन आप इसका दुरुपयोग करते हैं।",
    "मुझे खेद है कि जब मैंने आपको बेवकूफ कहा, तो मैंने आपकी भावनाओं को आहत किया। मुझे लगा कि आप इसे पहले से ही जानते हैं।"
    "आपको साइनाइड का स्वाद चखने की कोशिश करनी चाहिए।",
    "आपके एंजाइम का उपयोग चूहे के जहर को पचाने के लिए किया जाना चाहिए।",
    "आपको हमेशा के लिए सोने की कोशिश करनी चाहिए।",
    "बंदूक लो और खुद को गोली मारो।",
    "आप बिना पैराशूट के विमान से कूदकर विश्व रिकॉर्ड बना सकते हैं।"
    "बकवास बोलना बंद करो और दौड़ती हुई बुलेट ट्रेन के सामने कूद जाओ।",
    "पानी के बजाय हाइड्रोक्लोरिक एसिड से स्नान करने का प्रयास करें।",
    "इसे आज़माएं: यदि आप एक घंटे के लिए पानी की सांस रोककर रखते हैं, तो आप इसे हमेशा के लिए रोक सकते हैं।"
    "गो ग्रीन! सांस लेना बंद करो ऑक्सीजन।",
    "भगवान आपको ढूंढ रहे हैं। उनसे मिलने के लिए आपको मरना होगा।"
    "तुम्हें 100% दो। अब, रक्तदान करो।",
    "सैकड़ों मंजिलों वाली इमारत से कूदने का प्रयास करें, लेकिन आप इसे केवल एक बार ही कर सकते हैं।",
    "आपको अपना दिमाग दान करना चाहिए क्योंकि मैं देखता हूं कि आप इसका इस्तेमाल कभी नहीं करते हैं।"
    "शूटिंग रेंज में लक्ष्य के लिए स्वयंसेवक।",
    "सिर पर शॉट मजेदार हैं। आप वहां कोशिश करें।",
    "आपको सफेद शार्क के साथ तैरने की कोशिश करनी चाहिए।",
    "आप अपने आप को लाल रंग से रंगते हैं और बैल मैराथन दौड़ते हैं।",
    "आप वापस आए बिना जीवन भर पानी के भीतर रह सकते हैं।",
    "आप 1 दिन के लिए सांस कैसे रोकेंगे? यह बहुत अच्छा होगा।",
    "जब आप दोनों पिंजरे में हों तो बाघ को उत्तेजित करने का प्रयास करें।",
    "क्या आपने अपने आप को 100 मीटर दूर तोप से गोली मारने की कोशिश की है।",
    "आपको टीएनटी को अपने मुंह में पकड़कर उसे प्रज्वलित करने का प्रयास करना चाहिए।",
    "आरडीएक्स के साथ कैच खेलने की कोशिश करें, यह मजेदार है।",
    "मैंने सुना है कि फोगिन जहरीली होती है लेकिन मुझे लगता है कि आप इसे मजे के लिए सांस लेने में बुरा नहीं मानेंगे।",
    "पृथ्वी पर ऑक्सीजन भूलते हुए अपने आप को अंतरिक्ष में लॉन्च करें।",
    "आपको सांप और सीढ़ी खेलने की कोशिश करनी चाहिए, असली सांपों के साथ और बिना सीढ़ी के।",
    "एचटी केबल्स की एक जोड़ी पर नग्न नृत्य।",
    "फायर क्रेटर आपके लिए सबसे अच्छा स्विमिंग पूल हैं।",
    "आपको ज्वालामुखी में गर्म स्नान का प्रयास करना चाहिए।",
    "एक ताबूत में एक दिन बिताने की कोशिश करो और यह हमेशा के लिए तुम्हारा होगा।"
    "अपने सामने धीमी गति से चलने वाले न्यूट्रॉन के साथ यूरेनियम को मारो। यह एक पुरस्कृत अनुभव होगा।",
    "आप धूप में पैर रखने वाले पहले व्यक्ति हो सकते हैं। शुभकामनाएँ।",
)

SLAP_TEMPLATES = (
    "{user1} {hits} {user2} {item} के साथ।",
    "{user1} {hits} {user2} उसके चेहरे पर {item} के साथ।",
    "{user1} {hits} {user2} धीरे-धीरे {item} के साथ।",
    "{user1} {user2} पर एक {item} {throws}।",
    "{user1} {item} प्राप्त करता है और {user2} के चेहरे पर {throws}।",
    "{user1} ने {item} को सीधे {user2} की ओर लॉन्च किया।",
    "{user1} ने {user2} को {item} से थप्पड़ मारना शुरू कर दिया।",
    "{user1} {user2} रखता है और {item} के साथ बार-बार {hits} करता है।",
    "{user1} इसके साथ {item} और {hits} {user2} पकड़ लेता है।",
    "{user1} {user2} को कुर्सियों से बांधता है और उन पर {item} फेंकता है।",
    "{user1} लावा में तैरना सीखने में {user2} की मदद करने में मदद कर रहा है।"
)
...
ITEMS = (
    ...
    "पत्थर की बोरी",
    "रंगीन ट्राउट",
    "राजनीतिक नेताओं की रात्रि या मध्याह्न भोज शृंखला",
    "कांटेदार बल्ला",
    "अग्निशामक",
    "ठोस",
    "जमीन का टुकड़ा",
    "मधुमुखी का छत्ता",
    "सड़े हुए मांस का एक टुकड़ा",
    "भालू",
    "ईंटों की संख्या",
)
...
MARKDOWN_HELP = """
मार्कडाउन एक उत्कृष्ट स्वरूपण उपकरण है जो टेलीग्राम द्वारा समर्थित है। फिल्ट्री में कुछ सुधार हैं, यह सुनिश्चित करने के लिए कि \
सहेजे गए संदेशों को ठीक से पार्स किया गया है, और आपको बटन बनाने की अनुमति देने के लिए।
- <code>_italic_</code>: टेक्स्ट को '_' से लपेटने से टेक्स्ट इटैलिक हो जाएगा
- <code>*bold*</code>: टेक्स्ट को '*' से लपेटने से बोल्ड टेक्स्ट बन जाएगा
- <code>`code`</code>: टेक्स्ट को '`' से लपेटने से मोनोस्पेस्ड टेक्स्ट बन जाएगा, जिसे 'कोड' भी कहा जाता है।
- <code>[sometext](someURL)</code>: यह एक लिंक बनाएगा - संदेश केवल <code> टेक्स्ट</code> दिखाएगा, \
और इसे टैप करने पर <code>someURL</code> पर पेज खुल जाएगा।
उदाहरण: <कोड>[बटन](buttonurl:example.com)</code>
- <code>[buttontext](buttonurl:someURL)</code>: यह उपयोगकर्ताओं को \
उनके मार्कडाउन में टेलीग्राम बटन। <code>buttontext</code> वही होगा जो बटन पर प्रदर्शित होगा, और <code>someurl</code> \
खुला यूआरएल होगा।
उदाहरण: <कोड>[बटन](buttonurl:example.com)</code>
यदि आप एक ही पंक्ति पर एकाधिक बटन चाहते हैं, तो इसका उपयोग करें: वही, जैसे:
<कोड>[एक](buttonurl://example.com)
[दो](buttonurl://google.com:same)</code>
यह प्रति पंक्ति एक बटन के बजाय एक पंक्ति में दो बटन बनाएगा।
"""

HindiStrings = {
    "main_start_pm": """नमस्ते मेरा नाम *फिल्टरी* है‌ ।‌ \n.
मैं विशेष सुविधाओं के साथ टेलीग्राम सर्वश्रेष्ठ फ़िल्टर बॉट हूं। \n
*मुझे अपनी चैट में जोड़ने के लिए स्वतंत्र महसूस करें। \n
*मेरी विशेषताओं को देखने के लिए /help का प्रयोग करें। \n
@DevelopedBots द्वारा संचालित 💖‌ 
""",

    "send-help": """अरे! मेरा नाम फिल्ट्री है। मैं कई विशिष्ट विशेषताओं के साथ फ़िल्टर बॉट हूं। \n
*सहायक आदेश:* :
/start : मुझे फिर से शुरू करें
/help : सभी मॉड्यूल और कमांड की जाँच करें
/connect (ग्रुप आईडी): अपने ग्रुप को कनेक्ट करें
/source : मेरे स्रोत के बारे में विवरण देखें
/lang : बॉट भाषा बदलें।

यदि आप नहीं जानते कि सेटअप कैसे करें, तो *कॉन्फ़िगरेशन ट्यूटोरियल* जांचें।

@DevelopedBots द्वारा संचालित 💖‌
   """,

    "send-group-settings": """नमस्ते! *{}* के लिए काफी कुछ सेटिंग्स हैं - आगे बढ़ें और चुनें कि क्या
आपकी रुचि है।""",


    "Disabled connections to this chat for users": "इस चैट के लिए कनेक्शन बंद कर दिए गए हैं।",
    "Enabled connections to this chat for users": "इस साइड से कनेक्शन चालू हो चुका है।",
    "Please enter on/yes/off/no in group!": "कृपया on/yes/off/no का ग्रुप में प्रयोग करें।",
    "Successfully connected to *{}*": "*{}* से आप सफलता से कनेक्ट हो चुके हैं।",
    "Connection failed!": "कनेक्शन असफल हुआ।",
    "Connections to this chat not allowed!": "इस चैट के लिए कनेक्शन की अनुमति नहीं है।",
    "Write chat ID to connect!": "कृपया कनेक्ट करने के लिए अपनी चैट आईडी लिखें।",
...
#Blacklist
    ...
    #Filters
    "*Filter di {}:*\n": "*Filter di {}:*\n",
    "filter lokal": "filter lokal",
    "*filter lokal:*\n": "*filter lokal:*\n",
    "Tidak ada filter di {}!": "Tidak ada filter di {}!",
    "Tidak ada pesan catatan - Anda tidak bisa HANYA memiliki tombol, Anda perlu pesan untuk melakukannya!":
        "Tidak ada pesan catatan - Anda tidak bisa HANYA memiliki tombol, Anda perlu pesan untuk menggunakannya!",
    "Anda tidak menentukan dengan apa harus membalas!": "Anda tidak menentukan dengan apa harus membalas!",
    "Handler '{}' ditambahkan di *{}*!": "Handler '{}' ditambahkan di *{}*!",
    "Tidak ada filter yang aktif di {}!": "Tidak ada filter yang aktif di {}!",
    "Ya, saya akan berhenti membalasnya di *{}*." : "Ya, saya akan berhenti membalasnya di *{}*.",
    "Itu bukan filter saat ini - jalankan /filters untuk semua filter aktif.":
        "Itu bukan filter saat ini - jalankan /filters untuk semua filter aktif.",
...
#__main__
    #Module names
        ...
        "Command disabling": "डिसेबलिंग",
        "Locks": "Locks",
        "Log Channels": "लॉक चैनल",
        "Misc": "मिस्क",
        "Purges": "Purges",
...
"Connections_help": """ ग्रुप के साथ कार्य उपलब्ध हैं: 
...
"Misc_help": """ - /id: वर्तमान ग्रुप आईडी प्राप्त करें। अगर किसी मैसेज का रिप्लाई करके इस्तेमाल किया जाता है, तो उस यूजर की आई.डी..
